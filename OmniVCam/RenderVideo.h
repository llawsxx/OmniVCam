...
typedef struct inout_context {
	...
	int64_t output_audio_prev_pts_time;
	int64_t output_audio_pts_time;
	int64_t output_audio_next_pts_time;
	...
	int64_t output_last_audio_in_sync_time;
	...
	int64_t output_video_last_block_time;
